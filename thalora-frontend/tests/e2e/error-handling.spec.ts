...
test.describe('Error Handling and Edge Cases', () => {
  ...
  test('should handle session timeout', async ({ page }) => {
    ...
    // Try to shorten URL
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', 'https://www.example.com');
  ...
  test('should handle special characters in URLs', async ({ page }) => {
    ...
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', specialUrl);
    await page.click('button:has-text("Shorten URL")');
  ...
  test('should handle unicode characters in URLs', async ({ page }) => {
    ...
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', unicodeUrl);
    await page.click('button:has-text("Shorten URL")');
  ...
  test('should handle concurrent URL shortening requests', async ({ page }) => {
    ...
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', 'https://www.example.com/concurrent-test');
