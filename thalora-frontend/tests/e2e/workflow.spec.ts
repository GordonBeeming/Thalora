...
test.describe('Complete User Workflow', () => {
  test('should complete full user journey', async ({ page, context }) => {
    ...
    for (const url of testUrls) {
      await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', url);
      ...
      if (url !== testUrls[testUrls.length - 1]) {
        await page.locator('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]').clear();
      }
    }
    ...
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', testUrls[0]);
    await page.click('button:has-text("Shorten URL")');
    await expect(page.locator('.url-display')).toBeVisible({ timeout: 10000 });
    ...
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', postLoginUrl);
    await page.click('button:has-text("Shorten URL")');
  ...
  test('should handle multiple browser tabs', async ({ context }) => {
    ...
    await page1.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', 'https://www.example.com/tab1');
    ...
    await page2.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', 'https://www.example.com/tab2');
  ...
  test('should handle network errors gracefully', async ({ page }) => {
    ...
    await page.fill('input[placeholder="Enter your URL here (e.g., gordonbeeming.com)"]', 'https://www.example.com/error-test');
    await page.click('button:has-text("Shorten URL")');
